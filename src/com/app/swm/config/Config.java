...
public class Config {
	...
	// 所有接口的url
	public static final String BASE_URL = "http://202.196.1.141/~tristan/"; 
	...
	public static final String apkUrl = BASE_URL+"file/"+"swm.apk";
	
	public final static String APP_NAME="StudyWithMe";
	...
	public static final String  TEMP_PATH= BASE_PATH+"/Android/data/com.app.swm/temp/";// 临时文件地址 
	public static final String  PACKAGE_PATH= BASE_PATH+"/Android/data/com.app.swm/";// 临时文件地址 
